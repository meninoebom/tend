      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="space-y-4">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-border bg-white px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50"
          >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-bg-root px-2 text-text-muted">or</span>
            </div>
          </div>
        </div>
